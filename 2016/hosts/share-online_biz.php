...
class dl_share_online_biz extends Download {
    ...
    public function CheckAcc($cookie){
        ...
        $data = $this->lib->curl("https://www.share-online.biz/user/profile", $cookie, "");
    ...
    public function Login($user, $pass){
		$data = $this->lib->curl("https://www.share-online.biz/user/login", "animations=1;newsscrl=1;page_language=english", "user={$user}&pass={$pass}");
    ...
    public function Leech($url) {
		...
		elseif(!preg_match('/var dl="(.*)";var file/', $data, $en64)) $this->error("Cannot get base64_encode", true, false);	
		else { 	
