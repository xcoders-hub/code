...
class dl_keep2share_cc extends Download {
	...
	public function CheckAcc($cookie){
		...
		if(stristr($data, 'Premium expires:')) return array(true, "Until ".$this->lib->cut_str($data, 'Premium expires: <b>','</b>')."<br/>Bandwidth available: ". $this->lib->cut_str($data, 'Available traffic (today):', '</a></b><br>'));
