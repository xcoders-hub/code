...
class dl_uploaded_net extends Download {
	...
	public function CheckAcc($cookie){
		...
		elseif(stristr($data, '<a href="register"><em>Premium</em></a>')) return array(true, $this->lib->cut_str($this->lib->cut_str($data, "Duration:</td>", "/th>"), "<th>", "<")."<br/>Bandwidth available: ". $this->lib->cut_str($data, '<th colspan="2"><b class="cB">', '</b></th>'));
