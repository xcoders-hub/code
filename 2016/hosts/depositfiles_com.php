...
class dl_depositfiles_com extends Download { 
	...
	public function CheckAcc($cookie){
		//echo $data = $this->lib->curl("http://depositfiles.com/gold/payment_history.php", $cookie, ""); die();
		...
		//	$checksubscribe = $this->lib->curl("http://depositfiles.com/gold/payment_subscribe_manage.php", $cookie, "");
			...
			return array(true, "Until ".$this->lib->cut_str($data, '<div class="access">You have Gold access until: <b>','</b></div>'));
		}
	...
	public function Leech($url) {
		...
		elseif($page['status'] == "OK" && isset($page['data']['download_url'])) return trim(str_replace("depositfiles.com", "depositfiles.com", $page['data']['download_url']));
